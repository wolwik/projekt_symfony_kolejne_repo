 ...
 */
final class Version20260521155903 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE questions CHANGE content content LONGTEXT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE questions CHANGE content content VARCHAR(1025) NOT NULL');
    }
}
