 ...
 */
final class Version20260529105236 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE answers (id INT AUTO_INCREMENT NOT NULL, content LONGTEXT NOT NULL, guest_email VARCHAR(255) NOT NULL, guest_nickname VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, question_id INT NOT NULL, INDEX IDX_50D0C6061E27F6BF (question_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
